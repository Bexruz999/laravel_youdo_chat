...
class Testbexruz extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bexruz:app';
    ...
    public function handle()
    {
        ...
        $SETTING_ALLOWED_HOSTS = array(
            '127.0.0.1', 'httpbin.org', 'github.com', 'user.uz', 'multi-restaurants.smartersvision.com' # change to restrict list to only domains you wish to allow clients to call via this proxy
        );
        $ALLOWED_HOSTS = array();
